...
import { InputType } from '@/src/utils/UserType/input.interface'
import { StyledOptions } from '@/src/utils/UserType/style.interface'

// export const InputBox = ({ name, value, onChange, onInput, placeholder, fontSize, icon }: InputType) => {
export const InputBox = ({ name, value, onInput, placeholder, fontSize, icon }: InputType) => {
